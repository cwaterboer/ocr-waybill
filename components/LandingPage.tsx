...
import { ArrowRight, CheckCircle, Cloud, FileText, Lock, Smartphone, Upload } from "lucide-react"
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary/10 via-background to-background">
        ...
        <div className="container relative z-10 mx-auto flex max-w-6xl flex-col items-center px-4 pt-32 pb-24 text-center md:pt-40 md:pb-32">
          <div className="animate-fade-in">
            ...
            <p className="mb-10 max-w-3xl text-xl text-muted-foreground md:text-2xl">
      ...
      <section id="how-it-works" className="container mx-auto max-w-6xl px-4 py-24">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 text-xl font-bold">1. Upload Your Document</h3>
            <p className="text-muted-foreground">Drag & drop PDFs or images of your waybills.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 text-xl font-bold">2. AI Extracts Data</h3>
            <p className="text-muted-foreground">OCR scans and converts it into a structured form.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 text-xl font-bold">3. Download & Automate</h3>
            <p className="text-muted-foreground">Get a ready-to-use digital document for your workflow.</p>
          </div>
        </div>
